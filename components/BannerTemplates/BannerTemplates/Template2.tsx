        ...
        <>
            {selectedCompany &&
                <WrapperCol
                    ...
                    <FlexColContainer className="absolute bottom-0 w-full h-full max-h-[230px] z-40">
                        ...
                        <FlexRowCenteredY className={`min-h-[109px] flex-1 w-full p-4 gap-4 overflow-hidden`} style={{ backgroundColor: primary.background, color: primary.text }}>
    ...
    return (
        <WrapperRow
            ...
            <FlexColContainer className="w-[50%] h-full">
                <FlexColContainer className="w-full p-4 gap-4 h-full" style={{ backgroundColor: primary.background, color: primary.text }}>
    ...
    return (
        ...
        >
            ...
            <FlexColContainer className="absolute bottom-0 max-h-[170px] h-full z-50 w-full">
                ...
                <FlexRowCenteredY className={`min-h-[70px] h-full w-full p-2 justify-between`} style={{ backgroundColor: primary.background, color: secondary.text }}>
                    <TextAreaDescription fontSize={fontSizeDescription} textValue={useOverrideOrDefault.description(bannerTextOverridesAll.descriptionText, bannerTextDefaults.comment)} />
                    <img src={logo} alt="test" className={`ms-auto h-auto min-w-[112px]`} style={{ width: `${logoSize}%` }} />
                </FlexRowCenteredY>
            </FlexColContainer>
        </WrapperCol>
    )
    ...
    return (
        ...
        >
            ...
            <FlexColContainer className="flex-1 h-full w-full">
                ...
                <FlexColCenteredX className={`max-h-[250px] h-full w-full p-4 gap-4`} style={{ backgroundColor: primary.background, color: secondary.text }}>
    ...
    return (
        ...
        >
            ...
            <FlexColContainer>
                ...
                <FlexRowCenteredY className={`w-full max-h-[100px] min-h-[70px]  p-2 gap-2 text-sm`} style={{ backgroundColor: primary.background, color: secondary.text }}>
                    <TextAreaDescription fontSize={fontSizeDescription} textValue={useOverrideOrDefault.description(bannerTextOverridesAll.descriptionText, bannerTextDefaults.comment)} />
                    <img src={logo} alt="test" className={`h-auto ms-auto min-w-[70px]`} style={{ width: `${logoSize}%` }} />
                </FlexRowCenteredY>
            </FlexColContainer>
        </WrapperCol>
    )
